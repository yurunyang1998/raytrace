...
void RenderWindow::ResetInterface()
    ...
    emissiveLightSlider     ->setValue          ((int) (renderParameters -> emissive                * PARAMETER_SCALING));
    ...
    ambientLightSlider      ->setValue          ((int) (renderParameters -> ambient                 * PARAMETER_SCALING));
    ...
    diffuseLightSlider      ->setValue          ((int) (renderParameters -> diffuse                 * PARAMETER_SCALING));
