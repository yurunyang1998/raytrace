...
class TexturedObject
    ...
    static std::vector<TexturedObject> ReadObjectStream(std::istream &geometryStream, std::istream &textureStream);

    // read routine returns true on success, failure otherwise
    static std::vector<TexturedObject> ReadObjectStreamMaterial(std::istream &geometryStream, std::istream &materialStream);
